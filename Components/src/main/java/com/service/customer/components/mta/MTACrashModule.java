package com.service.customer.components.mta;
    ...
    public static void initMtaCrashModule(Context app) {
        ...
        crashReporter.addCrashCallback(new StatCrashCallback() {
            ...
            public void onJniNativeCrash(String tombstoneString) {
                ...
                LogUtil.getInstance().print("MTA StatCrashCallback onJniNativeCrash:\n" + tombstoneString);
            }
            ...
            public void onJavaCrash(Thread thread, Throwable ex) {
                //thread:crash线程信息
                // ex:crash堆栈
                LogUtil.getInstance().print("MTA StatCrashCallback onJavaCrash:\n" + ex);
            }
        });
    }
}
