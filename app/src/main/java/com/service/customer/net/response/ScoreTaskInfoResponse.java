...
public class ScoreTaskInfoResponse extends JSONObjectResponse {

    public ScoreTaskInfoResponse() {
        super();
    }
    ...
    public void onProgress(int progress, long speed, boolean isDone) {
        LogUtil.getInstance().print("ScoreTaskInfoResponse's progress:" + progress + ",speed:" + speed + ",isDone:" + isDone);
    }
