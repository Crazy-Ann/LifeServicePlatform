...
public class SaveTaskInfoResponse extends JSONObjectResponse {

    public SaveTaskInfoResponse() {
        super();
    }
    ...
    public void onProgress(int progress, long speed, boolean isDone) {
        LogUtil.getInstance().print("SaveTaskInfoResponse's progress:" + progress + ",speed:" + speed + ",isDone:" + isDone);
    }
